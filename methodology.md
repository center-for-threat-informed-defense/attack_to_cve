...
| ---- | ---- | ---- | ---- | ---------- |
| General Improper Access Control | [See the Functionality Section](Attack_to_Vulnerability_Mapping_Methodology.md#functionality)  | [See the Functionality Section](Attack_to_Vulnerability_Mapping_Methodology.md#functionality) | N/A | The impacts of authentication, authorization, and permissions errors generally depend on the functionality missing the authentication, authorization or permission. |
